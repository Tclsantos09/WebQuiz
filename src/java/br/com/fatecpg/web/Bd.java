...
public class Bd {
    public static ArrayList<Questions> getTeste(){
        ...
        teste.add(new Questions("Ao definir uma classe em um programa orientado a objetos, o programador pode especificar um ou "
        ...
        teste.add(new Questions("Na programação orientada a objetos, há um mecanismo que permite definir modificadores de acesso. "
        ...
        teste.add(new Questions("A programação orientada a objetos:", "faz uso de conceitos como classe, interfaces e envio de mensagens.", 
        ...
        teste.add(new Questions("Se você transforma os atributos públicos de uma classe em atributos privados com métodos de acesso "
        ...
        teste.add(new Questions("Em um programa orientado a objetos, verifica-se que a classe X estende a classe Y. Ou seja, pode-se "
        ...
        teste.add(new Questions("Em Orientação a Objetos, para que uma subclasse de uma classe possa ter seu próprio comportamento, e "
        ...
        teste.add(new Questions("Assinale a alternativa que apresenta, corretamente, o conceito de programação orientada a objetos que "
        ...
        teste.add(new Questions("Na orientação a objetos, a alteração do comportamento dos métodos herdados das superclasses para um "
        ...
        teste.add(new Questions("Quais são os modos de visibilidades existentes em POO?", "público, protegido, privado", 
                new String[] {"pacote, classe, herança", 
                    "público, protegido, privado",
                    "protegido, pacote, privado", 
                    "abstrata, concreta, público"}));
        
        teste.add(new Questions("São linguagens orientadas a objeto:", "Java e PHP", 
                new String[] {"SQL e C++", 
                    "Pascal e Java",
                    "Delphi e Natural", 
                    "Java e PHP"}));
